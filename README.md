...
Folder titles come from the YouTube video, not the lyric/translation title, and precede the video ID for alphabetical sorting. They use lowercase Unicode letters and numbers, preserving Japanese; whitespace becomes a single hyphen and punctuation is removed. Matching and loading use the exact YouTube video ID regardless of title changes.
